 ...
 *Created by dhruv on 06-06-2019.
 */
class RechargeBoardAdapter(
    var mContext: Context,
    var arrayList: ArrayList<RechargeProviderResponse.Message.Provider>,
    var itemClicked: (RechargeProviderResponse.Message.Provider) -> Unit
) : RecyclerView.Adapter<RechargeBoardAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        val board: RechargeProviderResponse.Message.Provider = arrayList[position]
